...
def connect2Linux():
    ...
    #_IOSCommand = "ls"
    #_output = _sshClient.ssh_ExecCommand(_IOSCommand)
    _sshClient.scpWriteFile("/home/q4qum/PKM/PKM/20-AREAS/201-RKF/2010-Network/192.168.130.10_20240127.ios", "/usr/share/tftp/cisco/inventory/192.168.130.10_20240127.ios")
    _output = "Completed task"
    print(_output,'utf8')
    _sshClient.ssh_Close()